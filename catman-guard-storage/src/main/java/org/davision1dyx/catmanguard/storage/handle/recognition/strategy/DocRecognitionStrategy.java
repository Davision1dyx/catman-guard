...
@Slf4j
@Component
public class DocRecognitionStrategy implements RecognitionStrategy{

    private final MinerURecognizeTool minerURecognizeTool;

    public DocRecognitionStrategy(MinerURecognizeTool minerURecognizeTool) {
    ...
    @Override
    public String recognize(InputStream inputStream, String fileName) throws IOException {
        // 1.OCR识别，得到zip
        byte[] zipBytes = minerURecognizeTool.parseDocumentToZip(fileName, inputStream);
